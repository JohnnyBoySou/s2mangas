...
export default function Onboarding({ navigation, route, }) {
   ...
   // const addNotify = async () => {await AsyncStorage.setItem('@widescreen', 'false')}
     ...
     const Screen0 = ({ }) => { 
        return(
            ...
            <Animated.View entering={FadeInDown.delay(450)}>
                <Image source={require('../../assets/imgs/s22.png')} style={{width: 200, height: 256,  zIndex: 2, borderRadius: 16, 
                alignSelf: 'center',}}/>
                </Animated.View>
           
           
            <Title style={{fontSize: 28, textAlign: 'center', fontFamily: font.book, marginTop: 20,}}>Explore o Mundo {'\n'}dos Mangás!</Title>
            <Label style={{fontSize: 18, lineHeight: 22, width: 300, textAlign: 'center', marginTop: 10, alignSelf: 'center',}}>
            Bem-vindo ao aplicativo! Descubra mangás incríveis, mergulhe em histórias emocionantes e faça parte de uma comunidade de fãs apaixonados. Comece sua jornada agora!
            </Label>

            <Row style={{position: 'absolute', bottom: -100, flexGrow: 1, alignSelf:'center', marginHorizontal: 30, justifyContent: 'space-between',}}>
            <Pressable rippleColor='#ffffff90' borderless onPress={() => setFirst(false)} style={{backgroundColor: color.primary, alignSelf: 'center', borderRadius: 100, paddingVertical: 12, paddingHorizontal: 24,}}>
                <Title style={{fontSize: 18,}}>Conheçer</Title>
            </Pressable>
            </Row>
        </Column>
        </Animated.View>
     ...
     const Screen1 = ({ }) => { 
        return(
            ...
            <Animated.View entering={FadeInDown.delay(150)}>
                <Image source={require('./img1.png')} style={{width: 200, height: 256, position: 'absolute', zIndex: 2, borderRadius: 16, 
            ...
            <Title style={{fontSize: 38, textAlign: 'center', fontFamily: font.book, marginTop: 10,}}>Seu Feed {'\n'}personalizado!</Title>
            <Title style={{fontSize: 16, color: color.label, textAlign: 'center', fontFamily: font.book, marginTop: 2,}}>Conforme você lê, novas recomendações!</Title>
        </Column>
        </Animated.View>
        )
      }
     const Screen2 = ({ }) => { 
        return(
            ...
            <Column style={{alignSelf: 'center', width: '100%', }}>
               <Animated.View entering={FadeInDown.delay(150)}>
                <Image source={require('./img2.png')} style={{width: 200, height: 256, position: 'absolute', zIndex: 2, borderRadius: 16, 
                alignSelf: 'center', top: 130,}}/>
                </Animated.View>
            ...
            <Title style={{fontSize: 38, textAlign: 'center', fontFamily: font.book, marginTop: 10,}}>Salve na sua {'\n'}Coleção</Title>
            <Title style={{fontSize: 16, color: color.label, textAlign: 'center', fontFamily: font.book, marginTop: 2,}}>Organize como preferir seus favoritos!</Title>
     ...
     const Screen3 = ({ }) => { 
        return(
            ...
            <Column style={{alignSelf: 'center', width: '100%',}}>
            <Animated.View entering={FadeInDown.delay(150)}>
                <Image source={require('./img3.png')} style={{width: 200, height: 256, position: 'absolute', zIndex: 2, borderRadius: 16, 
                alignSelf: 'center', top: 130,}}/>
                </Animated.View>
            <Svg width={311} style={{alignSelf: 'center',zIndex: -99,}} height={470}  viewBox="0 0 181 310" fill="none"><Path opacity={0.9} d="M88.407 11C116.314 58.8983 15.719 59.4356 29.6806 97.964C46.2816 143.776 119.141 55.5102 154.161 89.3925C201.032 134.742 -14.5972 145.737 26.1568 196.655C46.443 222 118.674 156.585 140.443 196.655C164.724 241.346 27.9349 234.488 41.4433 282C48.4924 306.793 139.161 261.5 147.443 302" stroke="url(#paint0_linear_898_44)" strokeWidth={40} /><Defs><LinearGradient id="paint0_linear_898_44" x1={64.3995} y1={216.618} x2={138.204} y2={252.312} gradientUnits="userSpaceOnUse"><Stop stopColor="#52C4A2" /><Stop offset={1} stopColor="#FFF50A" /></LinearGradient></Defs></Svg>
            ...
            <Title style={{fontSize: 38, textAlign: 'center', fontFamily: font.book, marginTop: 10,}}>Ferramentas {'\n'}para leitura!</Title>
            <Title style={{fontSize: 16, color: color.label, textAlign: 'center', fontFamily: font.book, marginTop: 2,}}>Filtros, zoom, paginação e muito mais...</Title>
      ...
      const Screen4 = ({ }) => { 
        return(
            ...
            <Column style={{alignSelf: 'center', width: '100%',}}>
            <Animated.View entering={FadeInDown.delay(150)}>
                <Image source={require('./img4.png')} style={{width: 200, height: 256, position: 'absolute', zIndex: 2, borderRadius: 16, 
                alignSelf: 'center', top: 130,}}/>
                </Animated.View>
            <Svg width={311} style={{alignSelf: 'center',zIndex: -99,}} height={470}  viewBox="0 0 181 310" fill="none"><Path opacity={0.9} d="M88.407 11C116.314 58.8983 15.719 59.4356 29.6806 97.964C46.2816 143.776 119.141 55.5102 154.161 89.3925C201.032 134.742 -14.5972 145.737 26.1568 196.655C46.443 222 118.674 156.585 140.443 196.655C164.724 241.346 27.9349 234.488 41.4433 282C48.4924 306.793 139.161 261.5 147.443 302" stroke="url(#paint0_linear_911_85)" strokeWidth={40} /><Defs><LinearGradient id="paint0_linear_911_85" x1={64.3995} y1={216.618} x2={138.204} y2={252.312} gradientUnits="userSpaceOnUse"><Stop stopColor="#FFA826" /><Stop offset={1} stopColor="#FF81AE" /></LinearGradient></Defs></Svg>
            <Row style={{position: 'absolute', top: 100, alignSelf:'center',}}>
            ...
            <Title style={{fontSize: 38, textAlign: 'center', fontFamily: font.book, marginTop: 20,}}>E muuuuito {'\n'}mais!</Title>
            <Title style={{fontSize: 16, color: color.label, textAlign: 'center', fontFamily: font.book, marginTop: 2,}}>Novas funções e atualizações frequentemente.</Title>
...
return (
  <Main style={{paddingTop: 50, flex: 1,}}>
    ...
    <StatusBar style="light" />
       {!first &&
        <Row style={{justifyContent: 'space-between', alignItems: 'center',}}>
            <Bars current={current} color={color}/>
    ...
    </Row>:  <Row style={{position: 'absolute', bottom: 50, flexGrow: 1, alignSelf:'center', marginHorizontal: 30, justifyContent: 'space-between',}}>
