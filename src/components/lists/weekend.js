        ...
        <Column>
            <Column style={{ marginHorizontal: 20, }}>
                <Row style={{ justifyContent: 'space-between', alignItems: 'center',  }}>
                    ...
                    <Button onPress={() => {navigation.navigate('Section', { type: 'weekend'})}}  style={{ width: 46, height: 46, borderRadius: 100, backgroundColor: '#303030', justifyContent: 'center', alignItems: 'center',  }}>
